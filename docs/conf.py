...
def getVersion():
    ...
    base_init = os.path.join(doc_root, '../norm/__init__.py')
...
latex_documents = [
  ('index', 'norm.tex', u'norm Documentation',
   u'Matt Haggard', 'manual'),
]
...
man_pages = [
    ('index', 'norm', u'norm Documentation',
     [u'Matt Haggard'], 1)
]
...
texinfo_documents = [
  ('index', 'norm', u'norm Documentation',
   u'Matt Haggard', 'norm', 'One line description of project.',
   'Miscellaneous'),
]
